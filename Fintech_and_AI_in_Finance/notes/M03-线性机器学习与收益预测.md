...
> 1. **缺开头约 1 分钟**——首段 `00:56` 已是教授在回答学生关于 syllabus 的提问；`00:56`–`08:32` 是行政段（TA tutorial、期末考形式、评分构成、随机分组），讲义无对应页，已提取到 [[Fintech_and_AI_in_Finance/_meta/作业与DDL|作业与DDL]]、[[Fintech_and_AI_in_Finance/_meta/考点库|考点库]] 与 §9.2。
...
| # | 内容 | 时长 | 时间戳 | 小节 | 为什么值钱 |
|---|---|---|---|---|---|
| 1 | 🔴 **行政段全内容**：TA tutorial（周日上午 Zoom）、期末考形式（A4 手写 cheat sheet、2 小时、选择题同款、mock exam）、评分构成、随机分组 | ~7.6 min | `00:56`–`08:32` | 已回写 [[Fintech_and_AI_in_Finance/_meta/作业与DDL\|作业与DDL]] / [[Fintech_and_AI_in_Finance/_meta/考点库\|考点库]] | 讲义完全没有这一段，却直接决定期末考怎么考、参与分怎么算 |
