...
| 3 | Linear machine learning for return prediction | [[M03-线性机器学习与收益预测]] | ✅ **v0.9**（2026-09-17，`quality_spec: v1` strict PASS）· 讲义 56 页全覆盖 + `class03/` 5 个 CSV 全部重算 · **转录待补**（36 处 🎙️） |
...
| `Lec03_Linear_Machine_Learning.pdf` | 56 页 | ✅ **56 页全覆盖、9 页图视觉复核** → [[M03-线性机器学习与收益预测]]（v0.9） |
...
| `M03-transcript.txt` | — | ⏳ 2026-09-17（周四）课，待导出；到位后按 `.claude/skills/transcript-merge/` 合并，回填 M03 36 处 🎙️ |
...
| M03 笔记 | ✅ **v0.9**（2026-09-17）：56 页全覆盖，§2 共 36 个 leaf 小节、3.1 万字，strict PASS；转录待补 |
...
2. 盯 Canvas 确认 ML 投资作业的实际发布日（见 [[Fintech_and_AI_in_Finance/_meta/作业与DDL|作业与DDL]] §4 的时间冲突）
...
5. `shared/` 四个面板文件 Canvas 上也没有（2026-09-17 核实）——等 ML 作业发布或问 TA；M03 转录导出后合并
