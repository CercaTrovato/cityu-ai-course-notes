...
week: 2
date: 2026-09-09
source: "Week 2 PPT.pptx（47 页）+ Case 2 with solution.docx（GTech 12 笔 T 形账户案例）"
transcript: merged
prerequisites: [M01]
...
**9.**（📄 教授 2026-09-21 补发 `Case 2 with solution.docx`，带官方解答）GTech Inc. 2025 年 1 月（开业第一个月）12 笔交易，要求写出每笔的借贷分录、受影响账户的 T 形账户明细与期末余额，并编制 1 月 31 日试算表：1 日 业主投入 \$40,000 现金；2 日 预付一年办公室租金 \$24,000；3 日 现金购办公设备 \$8,000；5 日 赊购办公用品 \$1,500；15 日 提供咨询服务收现 \$9,000；20 日 向另一客户赊销服务 \$6,000；22 日 付当月水电费 \$800；25 日 付 \$1,000 现金偿还办公用品欠款；28 日 业主提取 \$2,000 现金私用；29 日 收到 20 日客户付款 \$4,000；30 日 计提一个月租金费用 \$2,000（从预付租金转出）；31 日 计提当月办公用品费用 \$1,100。
<details><summary>官方解答（docx 原文，脚本 `verify_ac6761_cases.py` C 段复核：12 个账户余额与试算表合计全部一致）</summary>

**分录**（借在前、贷在后；§2.4 借贷规则）：

| # | 借 | 贷 | 金额 | 一句话 |
|---|---|---|---|---|
| 1 | Cash | Owner's Capital | 40,000 | 投资 |
| 2 | Prepaid Rent | Cash | 24,000 | 预付 = 资产，不是费用 |
| 3 | Equipment | Cash | 8,000 | |
| 4 | Office Supplies | Accounts Payable | 1,500 | 赊购 |
| 5 | Cash | Service Revenue | 9,000 | |
| 6 | Accounts Receivable | Service Revenue | 6,000 | 赊销：收入照记 |
| 7 | Utilities Expense | Cash | 800 | |
| 8 | Accounts Payable | Cash | 1,000 | 还款 |
| 9 | Owner's Withdraw | Cash | 2,000 | 提款是权益减项，不是费用 |
| 10 | Cash | Accounts Receivable | 4,000 | 收回应收 |
| 11 | Rent Expense | Prepaid Rent | 2,000 | 调整分录：预付转费用 |
| 12 | Supplies Expense | Office Supplies | 1,100 | 调整分录：用品转费用 |

**T 形账户余额**（借方余额 Dr / 贷方余额 Cr）：Cash 17,200 Dr（40,000 + 9,000 + 4,000 − 24,000 − 8,000 − 800 − 1,000 − 2,000）；Accounts Receivable 2,000 Dr；Prepaid Rent 22,000 Dr；Office Supplies 400 Dr；Equipment 8,000 Dr；Accounts Payable 500 Cr；Owner's Capital 40,000 Cr；Owner's Withdraw 2,000 Dr；Service Revenue 15,000 Cr；Rent Expense 2,000 Dr；Utilities Expense 800 Dr；Supplies Expense 1,100 Dr。
...
**读法**：与 FastForward 16 笔（§2.6.3）相比多了两笔**调整分录**（11、12：把预付租金和办公用品按本月耗用转成费用）——这是 W2 讲义没有、但 docx 解答里出现的内容，⚪ 推测教授在为"期末调整"铺路。试算表平衡（§2.7.2）只说明借贷相等，不能证明每笔都记对。
</details>
...
| 2026-09-22 | **并入教授 9/21 补发的 `Case 2 with solution.docx`**：GTech 12 笔（含两笔调整分录）+ 12 个 T 形账户余额 + 试算表，进 §7 案例题第 9 题，含官方解答；数字由 `verify_ac6761_cases.py` 复核。正文其余未动 |
