...
L0 入场基线（监督学习、训练集 / 测试集、准确率、过拟合等）见 [[GenAI_in_Business/_meta/知识层级台账|知识层级台账]]。
...
完整登记见 [[GenAI_in_Business/_meta/知识层级台账#M02 引入（本讲）|知识层级台账 › M02 引入（本讲）]]。
...
M01 时最大的待确认项是"演示的 2 周去哪了"（[[GenAI_in_Business/_meta/作业与DDL#⚠️ 待确认|作业与DDL › 待确认]] ①）。9/11 的公告《Information Regarding the Group Project》给了答案：
...
M01 §2.9.5 提示注入 / 红队 / 纵深防御；M01 §2.10 NIST AI RMF（治理语言）；欧盟 AI 法案将在 [[AI_Ethics_and_Regulations/00-课程总览|IS5113]] M09 展开，本课 11/21 的 Responsible AI 也会回到这里——本讲只需知道"有法规要求做对抗测试"。
...
> 出处见 [[GenAI_in_Business/_meta/术语表|术语表]]；基准名称（MMLU、GPQA…）不单列术语卡，见 §4.1。
...
- 📄 `IS5542 Project Template.pptx`（9 页）已在 §2.1.2 转写；完整要求登记在 [[GenAI_in_Business/_meta/作业与DDL|作业与DDL]]。
...
> **课程入口**：[[GenAI_in_Business/00-课程总览|00-课程总览]] ｜ **上一讲**：[[M01-导论-生成式AI基础与企业落地|M01]] ｜ **下一讲**：L3（9/19，🎙️ 教授明说讲 agent 与 RAG）
> **跨课**：安全基准与前沿安全框架 ↔ [[AI_Ethics_and_Regulations/00-课程总览|IS5113]] M09（EU AI Act）；评测协议的"固定任务集 + 留出集"思路 ↔ [[M02-回归与样本外设计|EF5560 M02]]（样本外纪律）
