...
| 4 | Nonlinear machine learning for return prediction | [[M04-非线性机器学习与收益预测]] | ✅ **v0.9 课前预习版**（2026-09-21，`quality_spec: v1` strict PASS）· 讲义 54 页全覆盖 · `class04/` 16 个文件重算 + 三棵树用共享面板重训一致 · 转录待 9/24 |
...
| `Lec04_Nonlinear_Machine_Learning.pdf` | 54 页 | ✅ **54 页全覆盖、9 页图视觉复核** → [[M04-非线性机器学习与收益预测]]（**v0.9** 课前版） |
...
| M03 笔记 | ✅ **v1.0**（2026-09-17）：56 页全覆盖，§2 共 36 个 leaf 小节、3.1 万字，strict PASS；转录已合并（35 个 🎙️ 格、7 条 🔴、audit PASS）；❗ 2026-09-21 勘误：§2.8.1 个股重算基于截断文件，待重下复核 |
| M04 笔记 | ✅ **v0.9 课前预习版**（2026-09-21）：54 页全覆盖，§2 共 37 个 leaf 小节、3.8 万字，strict PASS；三棵树用共享面板重训一致；转录待 9/24 |
...
2. 盯 Canvas 确认 ML 投资作业的实际发布日（见 [[EF5560_Fintech_and_AI_in_Finance/_meta/作业与DDL|作业与DDL]] §4 的时间冲突；M03 转录只剧透了内容——改窗口长度重跑排序，没给新发布日）
...
8. 9/24 录完 → `lt.py export --module M04` → transcript-merge → M04 升 v1.0
