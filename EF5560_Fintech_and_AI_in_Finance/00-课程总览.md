...
| `class03/class03/*.csv` ×5 + `manifest.json` + `README.md` | 5 个结果表 | ✅ sha256 校验 + 全部数字重算 → [[EF5560_Fintech_and_AI_in_Finance/_meta/数据集卡片\|数据集卡片]] §11；❗ README 引用的 `shared/` 四个面板缺失（Canvas 也没有，2026-09-17 核实） |
