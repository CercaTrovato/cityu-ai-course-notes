...
出处 M02 讲义 p.85–86，完整要求与准备提示见 [[AI_Ethics_and_Regulations/_meta/作业与DDL#⏰ 最近的截止|作业与DDL › ⏰ 最近的截止]]。
...
👉 **M03（9/15）新增可用工具**：差别性影响（"99% 准确率"是整体数字，各群体误识率可能不同）、程序公平四要素（被罚者有无申诉）、模型卡的"超范围用途"（OSCB 转用）——见 [[AI_Ethics_and_Regulations/_meta/作业与DDL#⏰ 最近的截止|作业与DDL]]。

⚠️ **M03 转录待导出**：9/15 的课 Notta 录音若有，请导出到 `transcripts/M03-transcript.txt`——M03 讲义 p.22–44 每页只有名词，课上怎么讲全靠转录；笔记里 39 处 🎙️ 等着回填。
...
| 3 | Bias and Fairness | [[M03-偏见与公平]] | ✅ **v0.9** · 讲义 89 页全覆盖（10 个低文本页逐页视觉复核，5 张图片卡片已誊录）· **无转录，待 Notta 导出**（2026-09-15） |
| 4 | Transparency and Explainability | | 待课件 |
...
| 文件 | 用途 |
|---|---|
| [[AI_Ethics_and_Regulations/_meta/知识层级台账\|知识层级台账]] | ★ 连贯性机制。L0 入场基线 + L1 概念登记表 |
| [[AI_Ethics_and_Regulations/_meta/术语表\|术语表]] | 累积的中英对照 + 可默写的英文定义 |
| [[AI_Ethics_and_Regulations/_meta/考点库\|考点库]] | 按可信度分级的考点，按 ILO 归集 |
| [[AI_Ethics_and_Regulations/_meta/作业与DDL\|作业与DDL]] | 作业、项目、考试的完整要求 |

## 前置资料

| 文件 | 用途 |
|---|---|
| [[AI_Ethics_and_Regulations/_prep/课程前置资料\|课程前置资料]] | 官方课程目录 × Course Outline **逐项对校**；项目定位；教授背景；13 周地图 |
...
| 文件 | 用途 |
|---|---|
| [[AI_Ethics_and_Regulations/CLAUDE\|课程级 CLAUDE.md]] / [[AI_Ethics_and_Regulations/AGENTS\|AGENTS.md]] | 本课特有规则：哲学术语译名规范、已知课件错误 |
...
- **IS6400 Business Data Analytics** — M03 §2.11.4 抽样偏见的现成例子：Airbnb 数据只有美国 6 城、NYC+LA 占 75%（[[Business_Data_Analytics/_meta/数据集卡片|数据集卡片]] §5.6）
