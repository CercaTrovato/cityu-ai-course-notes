...
| Bisecting KMeans | ⚪ M05（Syllabus 的 W04 聚类顺延一周） | 「一种反复二分的聚类法，聚类那讲展开」 |
| DBSCAN | ⚪ M05 | M01 p.19 的图上出现过全称，只需说"基于密度的聚类，聚类那讲展开" |
...
| 决策树 Decision Tree | ⚪ M05–M06（顺延待核） | M01 p.38 画过一棵；分裂准则见 M04 |
...
- [ ] 从预告清单里划掉本讲已展开的项
- [ ] 更新 [[Business_Data_Analytics/_meta/术语表|术语表]]、[[Business_Data_Analytics/_meta/考点库|考点库]]；有作业则更新 [[Business_Data_Analytics/_meta/作业与DDL|作业与DDL]]
- [ ] 跨课术语写进 [[Business_Data_Analytics/_meta/待并入术语总表|待并入术语总表]]（**不要直接改根 `_meta/术语总表.md`**）
